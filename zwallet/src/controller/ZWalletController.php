<?php
namespace Zamena\ZWallet\controller;
use Illuminate\Http\Request;
use App\Http\Requests;
use App\Http\Controllers\Controller;
use Zamena\ZWallet\AccountModel;
use Zamena\ZWallet\AccountTypeModel;
use Zamena\ZWallet\TransactionTypeModel;
use Zamena\ZWallet\AdminLogin;
use Session;
use Illuminate\Support\Facades\Redirect;
use Illuminate\Support\Facades\Hash;
class ZWalletController extends Controller
{
